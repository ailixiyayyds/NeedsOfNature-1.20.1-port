...
public final class NonWildfireGenderSync {
    ...
    public static void syncDestroyedSkinOverrides(NonConfig config) {
        ...
        NonWildfireGenderSync.syncDestroyedSkinOverrides(config, NonDestroyedSkinClient.getStage(client.field_1724.method_5667()));
    }
    ...
    public static void syncDestroyedSkinOverrides(NonConfig config, int destroyedStage) {
        ...
        try {
            Object playerConfig = getPlayerByIdMethod.invoke(null, client.field_1724.method_5667());
    ...
    public static boolean openBreastCustomizationScreen(class_437 parent) {
        if (!NonWildfireGenderSync.isAvailable() || !NonWildfireGenderSync.init()) {
            return false;
        }
        class_310 client = class_310.method_1551();
        if (client == null || client.field_1724 == null || breastCustomizationScreenConstructor == null) {
            return false;
        }
        try {
            Object screen = breastCustomizationScreenConstructor.newInstance(parent, client.field_1724.method_5667());
            if (screen instanceof class_437) {
                class_437 minecraftScreen = (class_437)screen;
                client.method_1507(minecraftScreen);
                return true;
            }
        }
        catch (ReflectiveOperationException | RuntimeException e) {
     ...
     */
    public static boolean renderBreastPreview(class_437 parent, class_332 context, NonConfig.FemaleGenderDestroyedProfile profile, int centerX, int frameY, int mouseX, int mouseY) {
        if (parent == null || context == null || profile == null || !NonWildfireGenderSync.isAvailable() || !NonWildfireGenderSync.init()) {
            return false;
        }
        class_310 client = class_310.method_1551();
        if (client == null || client.field_1724 == null || breastCustomizationScreenConstructor == null || renderPlayerInFrameMethod == null) {
            return false;
        }
        try {
            Object playerConfig = getPlayerByIdMethod.invoke(null, client.field_1724.method_5667());
    ...
    private static boolean init() {
        ...
        try {
            ...
            breastCustomizationScreenConstructor = breastCustomizationScreenClass.getConstructor(class_437.class, UUID.class);
            Class<?> baseWildfireScreenClass = Class.forName("com.wildfire.gui.screen.BaseWildfireScreen");
            renderPlayerInFrameMethod = baseWildfireScreenClass.getDeclaredMethod("renderPlayerInFrame", class_332.class, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE);
