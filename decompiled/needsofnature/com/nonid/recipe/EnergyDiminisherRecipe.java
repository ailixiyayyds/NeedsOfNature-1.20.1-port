...
extends AbstractEnergyAdjustRecipe {
    public EnergyDiminisherRecipe(class_7710 category) {
        super(category);
    }

    @Override
    protected boolean isRequiredFungus(class_1799 stack) {
        return stack.method_31574(class_1802.field_21988);
    }
    ...
    protected class_1799 getResultStack() {
        return new class_1799((class_1935)NeedsOfNature.ENERGY_DIMINISHER);
    }
