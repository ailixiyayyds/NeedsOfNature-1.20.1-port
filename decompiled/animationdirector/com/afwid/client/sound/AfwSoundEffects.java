...
public final class AfwSoundEffects {
    private static volatile Map<class_2960, Map<String, SoundAnimation>> SOUND_BY_ANIMATION = Map.of();
    private static final class_2960 RELOADER_ID = class_2960.method_60655((String)"animationframework", (String)"afw_sound_effects");
    ...
    public static SoundAnimation getSoundAnimation(class_2960 animationResource, String animationKey) {
    ...
    private static void reload(class_3300 manager) {
        ...
        LinkedHashMap<class_2960, Map> loaded = new LinkedHashMap<class_2960, Map>();
        int cueCount = 0;
        for (Map.Entry entry : entries) {
            class_2960 fileId = (class_2960)entry.getKey();
            class_2960 animationId = AfwSoundEffects.animationIdFromPath(fileId);
        ...
        for (Map.Entry entry : loaded.entrySet()) {
            finalized.put((class_2960)entry.getKey(), Map.copyOf((Map)entry.getValue()));
        }
    ...
    private static List<SoundCue> readSoundCues(JsonObject animObj, class_2960 fileId) {
