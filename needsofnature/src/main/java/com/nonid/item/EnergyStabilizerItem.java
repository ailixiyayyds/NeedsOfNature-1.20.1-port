...
extends Item {
    ...
    public Text getName(ItemStack stack) {
        ...
        EntityType<?> entityType = Registries.ENTITY_TYPE.get(target);
        Text entityName = entityType == null ? Text.literal(target.toString()) : entityType.getName();
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ...
        if ((class_19372 = user.getWorld()) instanceof ServerWorld) {
    ...
    public static void setTargetEntityTypeId(ItemStack stack, @Nullable Identifier entityTypeId) {
        ...
        nbt.putString(STABILIZER_ENTITY_DATA_KEY, entityTypeId == null ? "" : entityTypeId.toString());
    }
