...
extends Screen {
    ...
    protected void init() {
        ...
        this.dontShowAgainCheckbox = new CheckboxWidget(centerX - 170, checkboxY, 340, 20, Text.translatable("screen.needsofnature.warning.dont_show_again"), false);
        ...
        this.addDrawableChild(this.proceedButton);
        this.addDrawableChild(ButtonWidget.builder((Text)Text.translatable((String)"screen.needsofnature.warning.close_game"), button -> {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        List<OrderedText> lines = this.textRenderer.wrapLines((StringVisitable)this.warning.body(), 340);
        int y = boxY + 14;
