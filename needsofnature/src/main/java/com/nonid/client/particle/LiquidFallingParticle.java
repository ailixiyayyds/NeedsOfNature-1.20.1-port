...
extends LiquidLeakParticle {
    ...
    protected void updateVelocity() {
        ...
        if (this.world.getFluidState(pos).isIn(FluidTags.WATER)) {
            ...
            this.world.addParticle(NonParticles.LIQUID_PARTICLE_WATER, this.x + offsetX, this.y + offsetY, this.z + offsetZ, this.velocityX * 0.02, this.velocityY * 0.02, this.velocityZ * 0.02);
            return;
        }
        if (this.onGround) {
            ...
            this.world.playSound(this.x, this.y, this.z, sound, SoundCategory.BLOCKS, 0.6f, pitch, false);
            this.markDead();
            ...
            this.world.addParticle(NonParticles.LIQUID_PARTICLE_PUDDLE, this.x + offsetX, this.y + offsetY, this.z + offsetZ, 0.0, 0.0, 0.0);
        }
    }
    ...
    implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new LiquidFallingParticle(world, x, y, z, Fluids.LAVA, NonParticles.LIQUID_PARTICLE_PUDDLE, this.spriteProvider.getSprite(world.getRandom()));
        }
    }
}
