...
public final class AfwGeckoTickets {
    public static final DataTicket<@NotNull Identifier> AFW_ANIMATION_ID = DataTicket.create((String)"afw_animation_id", Identifier.class);
    public static final DataTicket<@NotNull Identifier> AFW_ANIMATION_RESOURCE_ID = DataTicket.create((String)"afw_animation_resource_id", Identifier.class);
    ...
    public static final DataTicket<@NotNull Identifier> MODEL_ID = DataTicket.create((String)"afw_model_id", Identifier.class);
    public static final DataTicket<@NotNull Identifier> TEXTURE_ID = DataTicket.create((String)"afw_texture_id", Identifier.class);
    public static final DataTicket<@NotNull List<Identifier>> LAYER_TEXTURES = DataTicket.create((String)"afw_layer_textures", List.class);
    public static final DataTicket<@NotNull List<Identifier>> EMISSIVE_TEXTURES = DataTicket.create((String)"afw_emissive_textures", List.class);
    public static final DataTicket<@NotNull Map<String, Identifier>> BONE_TEXTURES = DataTicket.create((String)"afw_bone_textures", Map.class);
    ...
    public static final DataTicket<@NotNull Identifier> LAST_AFW_ANIMATION_RESOURCE_ID = DataTicket.create((String)"afw_last_animation_resource_id", Identifier.class);
