...
final class NonModMenuPlayerScreens {
    ...
    extends Screen {
        ...
        protected void init() {
            ...
            this.addDrawableChild((Element)this.tintField);
            ...
            this.addDrawableChild((Element)useButton);
            ...
            this.addDrawableChild((Element)autoButton);
        ...
        public void render(DrawContext context, int mouseX, int mouseY, float delta) {
            ...
            if (this.skinTexture != null) {
                ...
                context.drawTexture(RenderPipelines.GUI_TEXTURED, this.skinTexture, this.skinX, this.skinY, 0.0f, 0.0f, this.skinSize, this.skinSize, 64, 64, 64, 64);
        ...
        private void loadSkinImage() {
            ...
            this.skinTexture = client.player.getSkin().comp_1626().comp_3627();
            try {
        ...
        private boolean tryPickColor(double mouseX, double mouseY) {
            ...
            int argb = this.skinImage.getColorArgb(pixelX, pixelY);
            if ((argb >>> 24 & 0xFF) < 32) {
                return true;
            }
    ...
    extends Screen {
        ...
        private Text playerGenderText(NonConfig.PlayerGenderSelection selection) {
            ...
            return switch (resolved) {
                ...
                case NonConfig.PlayerGenderSelection.MALE -> Text.translatable((String)"config.needsofnature.player_gender.male");
                case NonConfig.PlayerGenderSelection.FEMALE -> Text.translatable((String)"config.needsofnature.player_gender.female");
                case NonConfig.PlayerGenderSelection.BOTH -> Text.translatable((String)"config.needsofnature.player_gender.both");
            };
        }
